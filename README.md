...
| 5.7    | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
```bash
$ composer require "graham-campbell/gitlab:^5.7" "guzzlehttp/guzzle:^7.4" "http-interop/http-factory-guzzle:^1.0"
```
